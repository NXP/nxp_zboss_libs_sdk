...
[
    ...
    [ "Programming principles", "zigbee_prog_principles.html", [
      ...
      [ "Power saving for ZED", "zigbee_prog_principles.html#power_saving_zed", null ],
      [ "Power optimization", "zigbee_prog_principles.html#zigbee_power_optimization", null ],
    ...
    [ "Zigbee stack migration guide: v3.3.x to v4.0.0", "r23_migration.html", null ],
    [ "ZVD Developer's guide", "zvd_dev_guide.html", [
      [ "Requirements", "zvd_dev_guide.html#zvd_requirements", null ],
      [ "Environment", "zvd_dev_guide.html#zvd_environment", [
        [ "Install the following libraries:", "zvd_dev_guide.html#zvd_install_lib", null ],
        [ "Setup Bluez 5.63", "zvd_dev_guide.html#zvd_install_bluez", null ]
      ] ],
      [ "Create a ZVD application", "zvd_dev_guide.html#zvd_create_app", [
        [ "Initialization", "zvd_dev_guide.html#zvd_init", null ],
        [ "Start ZBOSS", "zvd_dev_guide.html#zvd_start_zboss", null ]
      ] ],
      [ "Connect to ZDD and create centralized network via ZVD", "zvd_dev_guide.html#zvd_connect_to_zdd", null ]
    ] ]
];