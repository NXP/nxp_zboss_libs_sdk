...
zb_uint8_t g_attr_long_byte_array[ZB_ZCL_CUSTOM_CLUSTER_ATTR_BYTE_ARRAY_MAX_SIZE] =
  ZB_ZCL_CUSTOM_CLUSTER_ATTR_BYTE_ARRAY_DEFAULT_VALUE;
...
static zb_zcl_status_t zb_zcl_custom_cluster_handler(zb_bufid_t buf, zb_zcl_parsed_hdr_t *cmd_info)
{
  ...
  switch (cmd_info->cmd_id)
  {
    ...
    case ZB_ZCL_CMD_WRITE_ATTRIB_UNDIV:
    {
      ...
      TRACE_MSG(TRACE_APP1, "ZB_ZCL_CMD_WRITE_ATTRIB_UNDIV command received", (FMT__0));
    ...
    case ZB_ZCL_CMD_READ_ATTRIB:
      TRACE_MSG(TRACE_ERROR, "ZB_ZCL_CMD_READ_ATTRIB command received", (FMT__0));
      resp_status = ZB_ZCL_STATUS_FAIL;
      break;
    default:
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        zb_bdb_finding_binding_target_ext(ENDPOINT_SERVER, ZB_FINDING_BINDING_TIMEOUT_S);
        break;
