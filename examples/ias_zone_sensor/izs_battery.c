...
zb_bool_t izs_voltage_under_threshold(zb_uint16_t voltage, zb_uint16_t threshold, zb_bool_t is_alarm_set)
{
  ...
  TRACE_MSG(TRACE_APP1, "> izs_voltage_under_threshold voltage %hd threshold %hd alarm_set %hd",
  ...
  TRACE_MSG(TRACE_APP1, "< izs_voltage_under_threshold ret %hd",
            (FMT__H, ret));
  return ret;
}
...
static void izs_check_voltage_value(zb_uint16_t voltage)
{
  ...
  TRACE_MSG(TRACE_APP1, "> izs_check_voltage_value voltage %d",
            (FMT__D, voltage));
 ...
 /* ZCL value is in 0.1V */
  ...
  TRACE_MSG(TRACE_APP1, "< izs_check_voltage_value", (FMT__0));
}
