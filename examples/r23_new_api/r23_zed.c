...
MAIN()
{
  ...
  zb_set_long_address(g_r23_zed_ieee_addr);
  ...
  /* Disable ZB_TLV_KEY_ECDHE_CURVE_25519_HASH_AESMMO128 method.
   * It means that ZED will use ZB_TLV_KEY_ECDHE_CURVE_25519_HASH_SHA256 during DLK.
   * Just for example */
  zb_disable_key_neg_method(ZB_TLV_KEY_ECDHE_CURVE_25519_HASH_AESMMO128);

  /* [ic_passcode_set_snippet] */
