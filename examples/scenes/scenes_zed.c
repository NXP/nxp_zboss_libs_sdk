...
void next_step(zb_uint8_t param)
{
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_ADD_SCENE)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 3, SCENES_TEST_STATE_SENT_ADD_SCENE, parse response",
        (FMT__0));
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_VIEW_SCENE)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 4, SCENES_TEST_STATE_SENT_VIEW_SCENE, do not parse response",
        (FMT__0));
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_REMOVE_ALL_SCENES)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 6, SCENES_TEST_STATE_SENT_REMOVE_ALL_SCENES, parse response",
        (FMT__0));
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_STORE_SCENE)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 7, SCENES_TEST_STATE_SENT_STORE_SCENE, parse response",
        (FMT__0));
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_RECALL_SCENE)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 9, SCENES_TEST_STATE_SENT_RECALL_SCENE, no response",
        (FMT__0));
  ...
  else if (g_test_state == SCENES_TEST_STATE_SENT_GET_SCENE_MEMBERSHIP)
  {
    TRACE_MSG(
        TRACE_APP3,
        "finishing test step 11, SCENES_TEST_STATE_SENT_GET_SCENE_MEMBERSHIP, parse response",
        (FMT__0));
  ...
  zb_zcl_parsed_hdr_t* cmd_info)
{
  ...
  if (ZB_ZCL_CLUSTER_ID_SCENES != cmd_info->cluster_id)
  {
    ...
    TRACE_MSG(TRACE_APP3, "COMMAND ID: 0x%hx, is successful: 0x%hx",
...
static void check_add_scene(zb_bufid_t zcl_cmd_buf)
{
         ...
         && response->scene_id == TEST_SCENE_ID_1))
  {
    ...
    TRACE_MSG(
        TRACE_ERROR,
        "ERROR Erroneous Scenes.AddSceneResponse status 0x%hx group_id 0x%04x scene_id %hd",
