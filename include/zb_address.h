...
/**
   Get LQI and RSSI values with reference.

   @param pan_id_ref - reference to Pan ID
   @param lqi - (output) lqi.
   @param rssi - (output) rssi
 */
void zb_address_get_diag_data(zb_address_pan_id_ref_t pan_id_ref, zb_uint8_t *lqi, zb_int8_t *rssi);
