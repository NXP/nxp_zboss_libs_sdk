...
#define  RET_INVALID_PARAMETER_5                 ERROR_CODE(ERROR_CATEGORY_GENERIC, 14)
#define  RET_INVALID_PARAMETER_6                 ERROR_CODE(ERROR_CATEGORY_GENERIC, 15)
#define  RET_INVALID_PARAMETER_7                 ERROR_CODE(ERROR_CATEGORY_GENERIC, 16)
#define  RET_INVALID_PARAMETER_8                 ERROR_CODE(ERROR_CATEGORY_GENERIC, 17)
#define  RET_INVALID_PARAMETER_9                 ERROR_CODE(ERROR_CATEGORY_GENERIC, 18)
