...
/* Integrate DSR fix:
 * eb83b890868962c5ba5013277d4481ed8522ecb5 from branch zoi_release-4.1.4.2_ns_200_samples
 * Author: vyacheslav.kostyuchenko <vyacheslav.kostyuchenko@dsr-corporation.com>  2024-12-09 16:09:44
 * Increase buffers and the scheduler queue size to 192
 * that has never been integrated into current
 * So make that changes owned by NXP not to lose it */
#define ZB_CONFIG_IOBUF_POOL_SIZE 192U
 ...
 * that has never been integrated into current
 * So make that changes owned by NXP not to lose it */
#define ZB_CONFIG_SCHEDULER_Q_SIZE 192U
