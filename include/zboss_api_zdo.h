...
/**
 * When generated:
 *   zb_zdo_mgmt_permit_joining_handle() has been called
 *
 * Status codes:
 * - RET_OK.
 *
 * This signal announces when ZDO mgmt permit join is detected
 *
 * Signal parameters: none
*/
# define ZB_ZDO_SIGNAL_RECV_PERMIT_JOIN_REQ  69U
...
typedef struct zb_zdo_signal_recv_permit_join_req_params_s
{
  zb_uint16_t src_addr;
  zb_uint8_t duration;
} zb_zdo_signal_recv_permit_join_req_params_t;
