...
#define IMAGE_TYPE_NXP_ZBOSS_LINUX_OFFSET  0x1000
#define IMAGE_TYPE_NXP_ZBOSS_MCXW71_OFFSET 0x2000
#define IMAGE_TYPE_NXP_ZBOSS_MCXW72_OFFSET 0x3000
#define IMAGE_TYPE_NXP_ZBOSS_RW612_OFFSET  0x4000
...
enum zb_zcl_ota_upgrade_nxp_image_type_e {
     ...
     */
        ...
        IMAGE_TYPE_NXP_ZBOSS_OFFSET = IMAGE_TYPE_NXP_ZBOSS_LINUX_OFFSET, /* Range 0x1000 ~ 0x1FFF */
#elif defined(ZB_PLATFORM_ZEPHYR) && defined(CONFIG_SOC_MCXW716C)
        IMAGE_TYPE_NXP_ZBOSS_OFFSET = IMAGE_TYPE_NXP_ZBOSS_MCXW71_OFFSET, /* Range 0x2000 ~ 0x2FFF */
#elif defined(ZB_PLATFORM_ZEPHYR) && defined(CONFIG_SOC_MCXW727C)
        IMAGE_TYPE_NXP_ZBOSS_OFFSET = IMAGE_TYPE_NXP_ZBOSS_MCXW72_OFFSET, /* Range 0x3000 ~ 0x3FFF */
#elif defined(ZB_PLATFORM_ZEPHYR) && defined(CONFIG_SOC_RW612)
        IMAGE_TYPE_NXP_ZBOSS_OFFSET = IMAGE_TYPE_NXP_ZBOSS_RW612_OFFSET, /* Range 0x4000 ~ 0x4FFF */
#else
#error Unknown Device type
    ...
    /* 0x140E: ota_client_zed */
    OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_APPLI_EXAMPLE_OTA_CLIENT_ED       = IMAGE_TYPE_NXP_ZBOSS_EXAMPLE_OFFSET  + 0x000E,
    /* NEXT... */


        IMAGE_TYPE_NXP_IW61X_OFFSET = 0x6120, /* Range 0x6120 ~ 0x612F */
        /*
         * header string:
         * - sd_w61x.bin(.se)
         * - sduart_nw61x.bin(.se)
         ...
         * - uartspi_n61x.bin(.se)
         *
         * iw61x version: <CC>.<DD>.<AA>p<BB> (example 18.99.3p4.x)
         ...
         */
             ...
             IMAGE_TYPE_NXP_IW61X_SD_ALONE_OFFSET    = IMAGE_TYPE_NXP_IW61X_OFFSET + 0x0000,
             IMAGE_TYPE_NXP_IW61X_SD_UART_OFFSET     = IMAGE_TYPE_NXP_IW61X_OFFSET + 0x0004,
             IMAGE_TYPE_NXP_IW61X_UART_UART_OFFSET   = IMAGE_TYPE_NXP_IW61X_OFFSET + 0x0008,
             IMAGE_TYPE_NXP_IW61X_UART_SPI_OFFSET    = IMAGE_TYPE_NXP_IW61X_OFFSET + 0x000C,
             IMAGE_TYPE_NXP_IW61X_MAX_OFFSET         = IMAGE_TYPE_NXP_IW61X_OFFSET + 0x0010,

             IMAGE_TYPE_NXP_IW61X_SIGNED_PROD_OFFSET = 0x0000,
             IMAGE_TYPE_NXP_IW61X_SIGNED_ENG_OFFSET  = 0x0001,
             IMAGE_TYPE_NXP_IW61X_UNSIGNED_OFFSET    = 0x0002,
             IMAGE_TYPE_NXP_IW61X_SIGNATURE_MASK     = 0x0003,

     /* 0x6120: sd_w61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_ALONE_SIGNED_PROD   = IMAGE_TYPE_NXP_IW61X_SD_ALONE_OFFSET  + IMAGE_TYPE_NXP_IW61X_SIGNED_PROD_OFFSET,
     /* 0x6121: sd_w61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_ALONE_SIGNED_ENG    = IMAGE_TYPE_NXP_IW61X_SD_ALONE_OFFSET  + IMAGE_TYPE_NXP_IW61X_SIGNED_ENG_OFFSET,
     /* 0x6122: sd_w61x.bin    */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_ALONE_UNSIGNED      = IMAGE_TYPE_NXP_IW61X_SD_ALONE_OFFSET  + IMAGE_TYPE_NXP_IW61X_UNSIGNED_OFFSET,
     /* 0x6124: sduart_nw61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_UART_SIGNED_PROD    = IMAGE_TYPE_NXP_IW61X_SD_UART_OFFSET   + IMAGE_TYPE_NXP_IW61X_SIGNED_PROD_OFFSET,
     /* 0x6125: sduart_nw61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_UART_SIGNED_ENG     = IMAGE_TYPE_NXP_IW61X_SD_UART_OFFSET   + IMAGE_TYPE_NXP_IW61X_SIGNED_ENG_OFFSET,
     /* 0x6126: sduart_nw61x.bin    */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_SD_UART_UNSIGNED       = IMAGE_TYPE_NXP_IW61X_SD_UART_OFFSET   + IMAGE_TYPE_NXP_IW61X_UNSIGNED_OFFSET,
     /* 0x6128: uartuart_n61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_UART_SIGNED_PROD  = IMAGE_TYPE_NXP_IW61X_UART_UART_OFFSET + IMAGE_TYPE_NXP_IW61X_SIGNED_PROD_OFFSET,
     /* 0x6129: uartuart_n61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_UART_SIGNED_ENG   = IMAGE_TYPE_NXP_IW61X_UART_UART_OFFSET + IMAGE_TYPE_NXP_IW61X_SIGNED_ENG_OFFSET,
     /* 0x612A: uartuart_n61x.bin    */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_UART_UNSIGNED     = IMAGE_TYPE_NXP_IW61X_UART_UART_OFFSET + IMAGE_TYPE_NXP_IW61X_UNSIGNED_OFFSET,
     /* 0x612C: uartspi_n61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_SPI_SIGNED_PROD   = IMAGE_TYPE_NXP_IW61X_UART_SPI_OFFSET  + IMAGE_TYPE_NXP_IW61X_SIGNED_PROD_OFFSET,
     /* 0x612D: uartspi_n61x.bin.se */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_SPI_SIGNED_ENG    = IMAGE_TYPE_NXP_IW61X_UART_SPI_OFFSET  + IMAGE_TYPE_NXP_IW61X_SIGNED_ENG_OFFSET,
     /* 0x612E: uartspi_n61x.bin    */
     OTA_UPGRADE_HEADER_IMAGE_TYPE_NXP_IW61X_UART_SPI_UNSIGNED      = IMAGE_TYPE_NXP_IW61X_UART_SPI_OFFSET  + IMAGE_TYPE_NXP_IW61X_UNSIGNED_OFFSET,
