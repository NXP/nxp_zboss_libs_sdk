...
void zb_zcl_ota_upgrade_client_set_custom_query_jitter(zb_uint8_t custom_query_jitter);
void zb_zcl_ota_upgrade_client_set_custom_query_timer_interval(zb_uint8_t custom_query_timer_interval);
