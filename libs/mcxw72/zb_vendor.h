 ...
 * DSR.
 */
/* PURPOSE: ZBOSS stack configuration file for MCXW72 host build
*/

#ifndef ZB_VENDOR_CFG_MCXW72_HOST_H
#define ZB_VENDOR_CFG_MCXW72_HOST_H 1
...
#define ZB_VENDOR_MEM_CONFIG "zb_mem_config_mcxw72.h"
