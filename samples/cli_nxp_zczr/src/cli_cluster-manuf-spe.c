...
#define CLUSTER_ATTR_FC02_CREATE_ATTR(type, variable, manuf_code) \
  { ((type) << 8) + 1, type, ACC_READ_ONLY | ((manuf_code != NO_MANUF_SPE) ? ACC_MANUF_SPEC : 0), manuf_code, (void*)&g_custom_nxp_attr.ro.variable }, \
  { ((type) << 8) + 2, type, ACC_WRITE_ONLY | ((manuf_code != NO_MANUF_SPE) ? ACC_MANUF_SPEC : 0), manuf_code, (void*)&g_custom_nxp_attr.ow.variable }, \
  { ((type) << 8) + 3, type, ACC_READ_ONLY | ACC_WRITE_ONLY | ((manuf_code != NO_MANUF_SPE) ? ACC_MANUF_SPEC : 0), manuf_code, (void*)&g_custom_nxp_attr.rw.variable }
...
static zb_zcl_attr_t cluster_attr_fc02[] = {
  ...
  /*!< Time of day, 4 bytes */                         CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_TIME_OF_DAY,       type_time_of_day,       ZB_MANUFACTURER_CODE_NXP),
  /*!< Date, 4 bytes */                                CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_DATE,              type_date,              ZB_MANUFACTURER_CODE_NXP),
  /*!< UTC Time, 4 bytes */                            CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_UTC_TIME,          type_utc_time,          ZB_MANUFACTURER_CODE_NXP),
  /*!< Cluster ID, 2 bytes */                          CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_CLUSTER_ID,        type_cluster_id,        ZB_MANUFACTURER_CODE_NXP),
  /*!< Attribute ID, 2 bytes */                        CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_ATTRIBUTE_ID,      type_attribute_id,      ZB_MANUFACTURER_CODE_NXP),
  /*!< BACnet OID, 4 bytes */                          CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_BACNET_OID,        type_bacnet_oid,        ZB_MANUFACTURER_CODE_NXP),
  /*!< IEEE address (U64) type */                      CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_IEEE_ADDR,         type_ieee_addr,         ZB_MANUFACTURER_CODE_NXP),
  /*!< 128-bit security key */                         CLUSTER_ATTR_FC02_CREATE_ATTR(ZB_ZCL_ATTR_TYPE_128_BIT_KEY,       type_128_bit_key,       ZB_MANUFACTURER_CODE_NXP),
  /* End of table */
