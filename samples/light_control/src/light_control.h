...
#define LIGHT_CONTROL_IEEE_ADDR {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
/* Buttons numbers */
#define LIGHT_CONTROL_BUTTON_OFF 1
#define LIGHT_CONTROL_BUTTON_ON 0

/* Time to determine either button is pressed for a long time to send set level command */
#define LIGHT_CONTROL_BUTTON_THRESHOLD ZB_TIME_ONE_SECOND
