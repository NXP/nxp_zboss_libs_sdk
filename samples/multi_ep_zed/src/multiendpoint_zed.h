...
#define MULTI_EP_ZED_DECLARE_EP1(ep_name, ep_id, cluster_list)                                     \
  ...
  ZBOSS_DEVICE_DECLARE_LEVEL_CONTROL_CTX(ep1_cvc_alarm_info## ep_name,          \
                                         EP1_CVC_ATTR_COUNT);                   \
...
#define MULTI_EP_ZED_DECLARE_EP2(ep_name, ep_id, cluster_list)                                     \
  ...
  ZBOSS_DEVICE_DECLARE_LEVEL_CONTROL_CTX(ep2_cvc_alarm_info## ep_name,          \
                                         EP2_CVC_ATTR_COUNT);                   \
  ZB_AF_DECLARE_ENDPOINT_DESC(ep_name, ep_id, ZB_AF_HA_PROFILE_ID,              \
    0,                                                                          \
    NULL,                                                                       \
...
#define ZB_ZCL_DECLARE_ALARMS_ATTRIB_LIST(attr_list, alarm_count) \
  ...
  ZB_ZCL_SET_MANUF_SPEC_ATTR_DESC(ZB_ZCL_ATTR_ALARMS_ALARM_COUNT_ID, ZB_ZCL_ATTR_TYPE_U16, \
                                  ZB_ZCL_ATTR_ACCESS_READ_WRITE, ZB_ZCL_NON_MANUFACTURER_SPECIFIC, (alarm_count)) \
...
#define MULTI_EP_ZED_DECLARE_EP5(ep_name, ep_id, cluster_list)                                     \
  ...
  ZBOSS_DEVICE_DECLARE_LEVEL_CONTROL_CTX(ep5_cvc_alarm_info## ep_name,          \
                                         EP5_CVC_ATTR_COUNT);                   \
  ZB_AF_DECLARE_ENDPOINT_DESC(ep_name, ep_id, ZB_AF_HA_PROFILE_ID,              \
    0,                                                                          \
    NULL,                                                                       \
